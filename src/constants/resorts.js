...
export const Resorts = Object.freeze([
    ...
    {name: 'Whistler Blackcomb', pass: EPIC, region: CANADA, days: -1, location: [50.115053, -122.948722]},
    {name: 'Keystone', pass: EPIC, region: ROCKIES, days: -1, location: [39.604729, -105.942661]},
    {name: 'Crested Butte', pass: EPIC, region: ROCKIES, days: -1, location: [38.899428, -106.966811]},
    {name: 'Beaver Creek', pass: EPIC, region: ROCKIES, days: -1, location: [39.604199, -106.516716]},
    {name: 'Breckenridge', pass: EPIC, region: ROCKIES, days: -1, location: [39.480482, -106.066765]},
    ...
    //Ikon
    {name: 'Winter Park', pass: IKON, region: ROCKIES, days: -1, location: [39.886662, -105.762995]},
    {name: 'Copper Mountain', pass: IKON, region: ROCKIES, days: -1, location: [39.499664, -106.155783]},
    {name: 'Eldora', pass: IKON, region: ROCKIES, days: -1, location: [39.937281, -105.582639]},
    {name: 'Squaw Valley', pass: IKON, region: TAHOE, days: -1, location: [39.197049, -120.235607]},
    ...
    {name: 'Apex', pass: INDY, region: CANADA, days: 2, location: [49.390750, -119.903840]},
    {name: 'Beaver Mountain', pass: INDY, region: UTAH, days: 2, location: [41.967611, -111.543414]},  
    {name: 'Brundage', pass: INDY, region: IDAHO, days: 2, location: [45.005354, -116.154423]},
    {name: 'Castle Mountain', pass: INDY, region: CANADA, days: 2, location: [49.319112, -114.412594]}, 
    ...
    {name: 'Mt Shasta Ski Park', pass: INDY, region: MAMMOTH, days: 2, location: [41.320665, -122.203784]}, 
    {name: 'Red Lodge', pass: INDY, region: MT, days: 2, location: [45.190713, -109.336579]}, 
    {name: 'Silver Mountain', pass: INDY, region: IDAHO, days: 2, location: [47.540354, -116.133603]}, 
